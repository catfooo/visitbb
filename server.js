...
//not works bcs of tag inbetween
//translated = translated.replace(/1 050충분한/g, "1 050 NOK");
//translated = translated.replace(/1 500충분한/g, "1 500 NOK");
if ($(el).attr("field") === "tn_text_1730453742642") {
  translated = translated.replace(/충분한/g, "NOK");
}
if ($(el).attr("field") === "tn_text_1730453746039") {
  translated = translated.replace(/충분한/g, "NOK");
}
...
translated = translated.replace(/무한한 북극/g, "끝없는 북극");
translated = translated.replace(/서해안/g, "서부 해안");
translated = translated.replace(/3일 스노모빌 투어/g, "3일 동안 진행되는 스노모빌 투어");
...
if ($(el).attr("field") === "tn_text_1725980849562") {
...
if (lastTextNode2 && lastTextNode2.data.trim() === ".") {
  lastTextNode2.data = "로 바뀌기 때문에 기대만큼 많은 것을 보지 못할 수도 있습니다.";
    ...
    $("body").append(`
    <a href="https://catfooo.github.io/visitbb/test.html">Test page</a>
<script>
// tilda slide fix
// ✅ slider CSS
